...
def build_fat32_sectors():
    ...
    inject_web_file(r"BURADA/Masaüsüt.png", "WALLPAPRPNG")
    inject_web_file(r"BURADA/Aurora.png",   "AURORA  PNG")
    inject_web_file(r"BURADA/dosyaYönetici.png", "EXPLORERPNG")
    inject_web_file(r"BURADA/firewall.png", "FIREWALLPNG")
    inject_web_file(r"BURADA/terminal.png", "TERMINALPNG")
    inject_web_file(r"BURADA/Baslat.png",   "START   PNG")
    inject_web_file(r"BURADA/Boot.png",     "BOOT    PNG")
    inject_web_file(r"BURADA/Kapat.png",    "SHUTDOWNPNG")
    inject_web_file(r"BURADA/YenidenBaşlat.png", "RESTART PNG")
